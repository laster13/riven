...
from routers.secure.script_router import router as script_router_router
...
app_router.include_router(script_router_router, dependencies=[Depends(resolve_api_key)])
